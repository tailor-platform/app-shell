...
- **Truncation tooltips**: long field/column names that are clipped in the add-filter and column-settings pickers now reveal their full text in a tooltip on hover.
