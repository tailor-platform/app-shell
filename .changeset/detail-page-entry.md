...
Three questions are marked **Team input needed** with a checkbox each, to be resolved before merge: whether AppShell should own a line-items component, how far a related-records table goes before it becomes its own screen, and whether a modal or Sheet is ever right for cross-checking a related record.
