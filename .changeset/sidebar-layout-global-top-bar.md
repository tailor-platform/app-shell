...
- `SidebarLayout.DefaultSidebar` gains `hideHeader`, `hideSearch`, and `iconRail`: defer the sidebar's own title and search to the top bar, and collapse to a persistent icon rail on desktop instead of sliding off-canvas.
