...
<!-- source: examples/components/layout-header-tabs.example.tsx -->

**Example — detail page, 2-column with area mode:**

<!-- source: examples/components/layout-detail-columns.example.tsx -->
...
<!-- source: examples/components/grid-metrics.example.tsx -->
...
<!-- source: examples/components/button-link-and-destructive.example.tsx -->
...
<!-- source: examples/components/dialog-confirm-delete.example.tsx -->
...
<!-- source: examples/components/sheet-filters.example.tsx -->
...
<!-- source: examples/components/menu-row-actions.example.tsx -->
...
<!-- source: examples/components/tabs-overview.example.tsx -->
...
<!-- source: examples/components/badge-variants.example.tsx -->
...
<!-- source: examples/components/table-orders.example.tsx -->
...
<!-- source: examples/components/data-table-shape.example.tsx -->
...
<!-- source: examples/components/card-basic.example.tsx -->
...
<!-- source: examples/components/card-bare-table.example.tsx -->

**Header + table (detail-page sections like "Line items"):**

<!-- source: examples/components/card-header-table.example.tsx -->

**DON'T — first column lands flush against the card edge:**

<!-- source: examples/components/card-table-dont.example.tsx -->
...
<!-- source: examples/components/metric-card-grid.example.tsx -->
...
<!-- source: examples/components/document-progress-card.example.tsx -->
...
<!-- source: examples/components/description-card.example.tsx -->
...
<!-- source: examples/components/action-panel.example.tsx -->
...
<!-- source: examples/components/alert-error.example.tsx -->
