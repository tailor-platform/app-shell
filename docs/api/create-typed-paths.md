...
<!-- GENERATED by docs-kit from docs-src/hooks/create-typed-paths.docs.outline.md — do not edit by hand. -->
...
See [File-Based Routing](../concepts/file-based-routing.md) for setup.

## Related

- [File-Based Routing](../concepts/file-based-routing.md) - Setup guide
- [useNavigate](./router/use-navigate.md) - Programmatic navigation
