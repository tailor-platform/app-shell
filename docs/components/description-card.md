...
<!-- GENERATED by docs-kit from docs-src/components/description-card.docs.outline.md — do not edit by hand. -->
...
| `columns?`      | `Columns`              | -       | Number of columns on desktop (3 or 4)                                    |
| `data`          | `TData`                | -       | Raw backend data object                                                  |
| `fields`        | `FieldConfig<TData>[]` | -       | Ordered list of field definitions (use { type: "divider" } for dividers) |
| `headerAction?` | `ReactNode`            | -       | Header action slot (e.g., edit button)                                   |
| `style?`        | `CSSProperties`        | -       | Inline styles                                                            |
| `title`         | `string`               | -       | Card title                                                               |

## Exports

- `DescriptionCard` — function
- `DescriptionCardProps` — interface
