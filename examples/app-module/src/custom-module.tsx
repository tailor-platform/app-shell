          ...
          <div style={cardStyle}>
            ...
            <Tabs.Root defaultValue="overview">
              ...
              <Tabs.Panel value="overview">
                <p style={{ padding: "0.75rem 0" }}>Overview content goes here.</p>
              </Tabs.Panel>
              <Tabs.Panel value="projects">
                <p style={{ padding: "0.75rem 0" }}>Projects content goes here.</p>
              </Tabs.Panel>
              <Tabs.Panel value="settings">
                <p style={{ padding: "0.75rem 0" }}>Settings content goes here.</p>
              </Tabs.Panel>
              <Tabs.Panel value="archived">
                <p style={{ padding: "0.75rem 0" }}>Archived content goes here.</p>
              </Tabs.Panel>
            </Tabs.Root>
          </div>
