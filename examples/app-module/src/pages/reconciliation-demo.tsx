...
const recordsById: Record<string, ReconciliationRecord> = {
  "1": {
    ...
    processingSteps: [
      {
        id: "s1",
        label: "Invoice uploaded by Admin User",
        status: "completed",
        timestamp: new Date("2026-04-07T19:20:33"),
      },
      {
        id: "s2",
        label: "OCR extraction started on uploaded PDF",
        status: "completed",
        timestamp: new Date("2026-04-07T19:20:35"),
      },
      {
        id: "s3",
        label: "AI agent extracted 2 line items, $7,854.01 total",
        status: "completed",
        timestamp: new Date("2026-04-07T19:21:17"),
      },
      {
        id: "s4",
        label: "AI agent ran three-way matching against PO-105539",
        status: "completed",
        timestamp: new Date("2026-04-07T19:21:17"),
      },
      {
        id: "s5",
        label: "Match completed — 100% score, all items matched",
        status: "completed",
  ...
  "2": {
    ...
    processingSteps: [
      ...
      {
        id: "s3",
        label: "AI agent extracted 2 line items, $157,990 total",
        status: "completed",
        timestamp: new Date("2026-04-07T19:21:17"),
      },
      {
        id: "s4",
        label: "AI agent ran three-way matching against PO-105539, PO-105541",
        status: "completed",
        timestamp: new Date("2026-04-07T19:21:17"),
      },
      {
        id: "s5",
        label: "Match completed — 75% score, 2 discrepancies found",
        status: "completed",
        timestamp: new Date("2026-04-07T19:21:42"),
      },
    ],
  ...
  "4": {
    ...
    processingSteps: [
      ...
      {
        id: "s3",
        label: "AI agent extracted 2 line items, $23,450 total",
        status: "completed",
        timestamp: new Date("2026-04-06T14:10:18"),
      },
      {
        id: "s4",
        label: "AI agent ran three-way matching against PO-108200",
        status: "completed",
        timestamp: new Date("2026-04-06T14:10:19"),
      },
      {
        id: "s5",
        label: "Match completed — 45% score, 2 discrepancies found",
        status: "completed",
  ...
  "5": {
    ...
    processingSteps: [
      ...
      { id: "s2", label: "OCR extraction in progress", status: "in_progress" },
    ...
    <Layout>
      ...
      <Layout.Column>
        <ReconciliationList
          ...
          onUpload={(file) => {
            alert(
              `Upload received: ${file.name}\n\nIn production, this triggers OCR extraction and three-way matching.`,
            );
          }}
...
const ReconciliationDetailPage = () => {
  ...
  // Simulate processing completing after 3 polls
  const displayRecord: ReconciliationRecord =
    record.status === "processing" && pollCount >= 3
      ? {
          ...record,
          status: "matched",
          matchScore: 100,
          summary: "All line items matched successfully (simulated).",
          processingSteps: record.processingSteps.map((s) => ({
            ...s,
