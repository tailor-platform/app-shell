import { Layout, MetricCard, type AppShellPageProps } from "@tailor-platform/app-shell";
...
MetricCardDemoPage.appShellPageProps = {
  meta: {
    title: "MetricCard Demo",
  },
} satisfies AppShellPageProps;

export default MetricCardDemoPage;
