...
describe("renderField", () => {
  describe("text", () => {
    it("renders text value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "text", value: "hello" }))}</>,
      );
    ...
    it("renders dash for empty value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "text", value: null }))}</>,
      );
  ...
  describe("badge", () => {
    it("renders badge with sentence case", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "badge", value: "CONFIRMED" }))}</>,
      );
    ...
    it("renders dash for empty value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "badge", value: null }))}</>,
      );
      expect(container.textContent).toBe("–");
    });
  });
  ...
  describe("money", () => {
    ...
    it("renders dash for empty value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "money", value: null }))}</>,
      );
      expect(container.textContent).toBe("–");
    });
  });
  ...
  describe("link", () => {
    ...
    it("renders dash for empty value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "link", value: null }))}</>,
      );
      expect(container.textContent).toBe("–");
    });
  });
  ...
  describe("address", () => {
    ...
    it("renders dash for empty value", () => {
      const { container } = render(
        <>{renderField(makeField({ type: "address", value: null }))}</>,
      );
      expect(container.textContent).toBe("–");
    });
  });
