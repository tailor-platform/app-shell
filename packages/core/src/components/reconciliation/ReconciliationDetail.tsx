...
function toLinkedRecord(doc: RelatedDocument): LinkedRecord {
  return {
    ...
    group: doc.autoGenerated ? "created" : "source",
    groupLabel: doc.autoGenerated ? "Created Invoice" : "Related Documents",
  };
}
      ...
      <Layout className="astw:lg:grid-cols-[1fr_320px]">
        ...
        {hasRightColumn && (
          <Layout.Column>
            ...
            {data.relatedDocuments.length > 0 && (
              <LinkedRecordsCard
                records={data.relatedDocuments.map(toLinkedRecord)}
                matchScore={
                  !isProcessing && !isError
                    ? {
                        value: data.matchScore,
                        statusLabel: statusLabel[data.status],
                        statusVariant: statusBadgeVariant[data.status],
                      }
                    : undefined
                }
              />
