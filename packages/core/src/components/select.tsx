...
function SelectTrigger({
  ...
  return (
    <BaseSelect.Trigger
      ...
      className={cn(
        "astw:border-input astw:bg-transparent astw:dark:bg-input/30 astw:transition-[color,box-shadow] astw:text-foreground astw:flex astw:h-9 astw:w-full astw:items-center astw:justify-between astw:gap-2 astw:rounded-md astw:border astw:px-3 astw:py-2 astw:text-sm astw:shadow-xs astw:outline-none",
