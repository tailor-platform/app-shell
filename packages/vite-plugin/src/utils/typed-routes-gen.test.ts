...
import { extractParams, generateParamsType, generateTypedRoutesCode } from "./typed-routes-gen";
...
describe("extractParams", () => {
  ...
  it("extracts multiple dynamic parameters", () => {
    expect(extractParams("/orders/:orderId/items/:itemId")).toEqual(["orderId", "itemId"]);
  });
...
describe("generateParamsType", () => {
  ...
  it("generates multiple params type", () => {
    expect(generateParamsType(["orderId", "itemId"])).toBe("{ orderId: string; itemId: string }");
  });
});
...
describe("generateTypedRoutesCode", () => {
  it("generates code for empty pages array", () => {
    ...
    expect(code).toContain('import { createTypedPaths } from "@tailor-platform/app-shell"');
    expect(code).toContain("export const paths = createTypedPaths<GeneratedRouteParams>();");
  });
  ...
  it("includes auto-generated header comment", () => {
    const code = generateTypedRoutesCode([]);
    expect(code).toContain("// Auto-generated by @tailor-platform/app-shell-vite-plugin");
